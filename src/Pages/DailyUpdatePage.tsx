...
import { Button, Link, Container, TableRow, TableHead, TableBody, TableCell, Grid, makeStyles, Typography } from '@material-ui/core';
...
const CustomerStats = () => {
    ...
    return (
        <React.Fragment>
            ...
            < Container maxWidth="md" style={{ marginTop: "50px", backgroundColor: "white" }}>
